...
const createProtocol = function(productId, marketId, manufacturerId, apiDetails, reference,
    ...
    return new Promise(function (resolve, reject) {
        axios.post('/healthcare/create_protocol', {
...
const getProtocols = function () {
    return new Promise(function (resolve, reject) {
        axios.get('/healthcare/get_protocols').then(function(res) {
            resolve(res.data);
        }).catch(function(err) {
...
const getProtocolDetail = function(protocolId) {
    return new Promise(function(resolve, reject) {
       axios.get(`/healthcare/protocol_detail/${protocolId}`).then(function(res) {
           resolve(res.data);
       }).catch(function(err) {
           reject(err);
       })
