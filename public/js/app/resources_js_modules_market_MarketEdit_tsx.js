(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_modules_market_MarketEdit_tsx"],{
...
/***/ "./resources/js/modules/market/MarketEdit.tsx":
/*!****************************************************!*\
  !*** ./resources/js/modules/market/MarketEdit.tsx ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _redux_market_actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./redux/market.actions */ "./resources/js/modules/market/redux/market.actions.ts");
/* harmony import */ var _redux_market_types__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./redux/market.types */ "./resources/js/modules/market/redux/market.types.ts");
...
var MarketEdit = function MarketEdit() {
  var _a, _b;
  ...
  var marketStateData = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useSelector)(function (state) {
    return state.marketState;
  });
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
    dispatch((0,_redux_market_actions__WEBPACK_IMPORTED_MODULE_9__.marketGetByIdAction)(id));
  }, []);
  ...
  var market = (_b = (_a = marketStateData === null || marketStateData === void 0 ? void 0 : marketStateData.data) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.market;
  var initialValues = {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return dispatch((0,_redux_market_actions__WEBPACK_IMPORTED_MODULE_9__.marketUpdateAction)(id, values));
          ...
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", Object.assign({
            ...
            children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", Object.assign({
              ...
              children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", Object.assign({
                ...
                actionTypes: [_redux_market_types__WEBPACK_IMPORTED_MODULE_10__["default"].MARKET_UPDATE_FAILED]
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MarketEdit);
...
/* harmony import */ var _market_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./market.types */ "./resources/js/modules/market/redux/market.types.ts");
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              dispatch({
                type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_START
              });
              _context.next = 3;
              return _config_api_auth_axios__WEBPACK_IMPORTED_MODULE_2__.AxiosAuthInstance.get("/markets?page=".concat((searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.page) || '', "&search_term=").concat((searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.searchTerm) || '', "&take=").concat((searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.take) || '')).then(function (res) {
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_GET_SUCCESS,
                  payload: res === null || res === void 0 ? void 0 : res.data
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                });
              }, function (error) {
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_GET_FAILED,
                  payload: error
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _config_api_auth_axios__WEBPACK_IMPORTED_MODULE_2__.AxiosAuthInstance.post("/market/create", formData).then(function (res) {
                var _a;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_CREATE_SUCCESS,
                  payload: res === null || res === void 0 ? void 0 : res.data
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.message, "success", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_CREATE_SUCCESS));
              }, function (error) {
                var _a, _b;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_CREATE_FAILED,
                  payload: true
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error, "danger", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_CREATE_FAILED));
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _config_api_auth_axios__WEBPACK_IMPORTED_MODULE_2__.AxiosAuthInstance.get("/market/".concat(id)).then(function (res) {
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_GET_BY_ID_SUCCESS,
                  payload: res === null || res === void 0 ? void 0 : res.data
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_GET_BY_ID_FAILED,
                  payload: error
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _config_api_auth_axios__WEBPACK_IMPORTED_MODULE_2__.AxiosAuthInstance.post("/market/".concat(id), formData).then(function (res) {
                var _a;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_UPDATE_SUCCESS,
                  payload: res === null || res === void 0 ? void 0 : res.data
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.message, "success", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_UPDATE_SUCCESS));
              }, function (error) {
                var _a, _b;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_UPDATE_FAILED,
                  payload: true
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error, "danger", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_UPDATE_FAILED));
              });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return _config_api_auth_axios__WEBPACK_IMPORTED_MODULE_2__.AxiosAuthInstance.post("/market/delete/".concat(id)).then(function (res) {
                var _a;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_DELETE_SUCCESS,
                  payload: res === null || res === void 0 ? void 0 : res.data
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.message, "success", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_DELETE_SUCCESS));
              }, function (error) {
                var _a, _b;

                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_DELETE_FAILED,
                  payload: true
                });
                dispatch({
                  type: _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_ACTION_END
                ...
                //! bad solution end
                _config_redux_store__WEBPACK_IMPORTED_MODULE_3__.store.dispatch((0,_components_snackbar_redux_alert_action__WEBPACK_IMPORTED_MODULE_1__.snackBarAlert)((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error, "danger", _market_types__WEBPACK_IMPORTED_MODULE_4__["default"].MARKET_DELETE_FAILED));
              });
